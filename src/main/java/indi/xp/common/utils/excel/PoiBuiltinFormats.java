...
public class PoiBuiltinFormats {
     ...
     * "h:mm:ss AM/PM" 0x14, "h:mm" 0x15, "h:mm:ss" 0x16, "m/d/yy h:mm" // 0x17
     * - 0x24 reserved for international and undocumented 0x25,
     ...
     * "_($* #,##0.00_);_($* (#,##0.00);_($* \"-\"??_);_(@_)" 0x2d, "mm:ss"
     * 0x2e, "[h]:mm:ss" 0x2f, "mm:ss.0" 0x30, "##0.0E+0" 0x31, "@" - This is
     * text format. 0x31 "text" - Alias for "@"
     * 
     * //164 "¥"#,##0;[Red]"¥"\-#,##0
     */
    ...
    static {
        ...
        dataFormatCache.put("_(\"€\"* #,##0.00_);_(\"€\"* \\(#,##0.00\\);_(\"€\"* \"-\"??_);_(@_)", "€ #,##0.00");
        dataFormatCache.put("_(\"€\"* #,##0_);_(\"€\"* \\(#,##0\\);_(\"€\"* \"-\"??_);_(@_)", "€ #,##0");
        dataFormatCache.put("_(* #,##0.00000_);_(* \\(#,##0.00000\\);_(* \"-\"??_);_(@_)", " #,##0.00000");
        dataFormatCache.put("_([$€-2]\\ * #,##0.00_);_([$€-2]\\ * \\(#,##0.00\\);_([$€-2]\\ * \"-\"??_);_(@_)",
            "€  #,##0.00");
        dataFormatCache.put("_([$€-2]\\ * #,##0.0_);_([$€-2]\\ * \\(#,##0.0\\);_([$€-2]\\ * \"-\"??_);_(@_)",
            "€  #,##0.0");
        dataFormatCache.put("_([$€-2]\\ * #,##0_);_([$€-2]\\ * \\(#,##0\\);_([$€-2]\\ * \"-\"??_);_(@_)", "€  #,##0");
        dataFormatCache.put("_-\"$\"* #,##0.00_-;\\-\"$\"* #,##0.00_-;_-\"$\"* \"-\"??_-;_-@", "$ #,##0.00");
        dataFormatCache.put("_-\"€\"\\ * #,##0.00_-;_-\"€\"\\ * #,##0.00\\-;_-\"€\"\\ * \"-\"??_-;_-@_-",
            "€  #,##0.00");
        dataFormatCache.put("_-\"€\"\\ * #,##0_-;_-\"€\"\\ * #,##0\\-;_-\"€\"\\ * \"-\"??_-;_-@_-", "€  #,##0");
        dataFormatCache.put("_-* #,##0.00000000\\ _€_-;\\-* #,##0.00000000\\ _€_-;_-* \"-\"??\\ _€_-;_-@_-",
            " #,##0.00000000 €");
        dataFormatCache.put("_-* #,##0.0000000\\ _€_-;\\-* #,##0.0000000\\ _€_-;_-* \"-\"??\\ _€_-;_-@_-",
            " #,##0.0000000 €");
        dataFormatCache.put("_-* #,##0.000000\\ _€_-;\\-* #,##0.000000\\ _€_-;_-* \"-\"??\\ _€_-;_-@_-",
            " #,##0.000000 €");
        dataFormatCache.put("_-* #,##0.00000_-;\\-* #,##0.00000_-;_-* \"-\"??_-;_-@_-", " #,##0.00000");
        dataFormatCache.put("_-* #,##0.0000_-;\\-* #,##0.0000_-;_-* \"-\"??_-;_-@_-", " #,##0.0000");
        dataFormatCache.put("_-* #,##0.000\\ _€_-;\\-* #,##0.000\\ _€_-;_-* \"-\"??\\ _€_-;_-@_-", " #,##0.000 €");
        dataFormatCache.put("_-* #,##0.00\\ _€_-;\\-* #,##0.00\\ _€_-;_-* \"-\"??\\ _€_-;_-@_-", " #,##0.00 €");
        dataFormatCache.put("_-* #,##0.00_-;\\-* #,##0.00_-;_-* \"-\"??_-;_-@", " #,##0.00");
        dataFormatCache.put("_-* #,##0.00_-;\\-* #,##0.00_-;_-* \"-\"??_-;_-@_-", " #,##0.00");
        dataFormatCache.put("_-* #,##0.00_-;_-* #,##0.00\\-;_-* \"-\"??_-;_-@_-", " #,##0.00");
        dataFormatCache.put("_-* #,##0.0\\ _€_-;\\-* #,##0.0\\ _€_-;_-* \"-\"??\\ _€_-;_-@_-", " #,##0.0 €");
        dataFormatCache.put("_-* #,##0.0\\ _€_-;\\-* #,##0.0\\ _€_-;_-* \"-\"?\\ _€_-;_-@_-", " #,##0.0 €");
        ...
        dataFormatCache.put("_-* #,##0_-;\\-* #,##0_-;_-* \"-\"??_-;_-@_-", " #,##0");
        dataFormatCache.put("_-* #,##0_-;_-* #,##0\\-;_-* \"-\"??_-;_-@_-", " #,##0");
        dataFormatCache.put("_-[$$-409]* #,##0.00_ ;_-[$$-409]* \\-#,##0.00\\ ;_-[$$-409]* \"-\"??_ ;_-@_ ",
            "$ #,##0.00");
        dataFormatCache.put("_-[$€-2]\\ * #,##0.00_-;_-[$€-2]\\ * #,##0.00\\-;_-[$€-2]\\ * \"-\"??_-;_-@_-",
            "€  #,##0.00");
