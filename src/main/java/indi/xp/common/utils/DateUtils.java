...
public class DateUtils {
    ...
    private static SimpleDateFormat defaultDateFormater = new SimpleDateFormat("yyyy-MM-dd");
    private static SimpleDateFormat defaultDatetimeFormater = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static String getDate() {
        return defaultDateFormater.format(new Date());
    }
    ...
    public static Boolean isSameDay(String sDate, String eDate) {
        return StringUtils.isNotBlank(sDate, eDate)
            && DateUtils.replaceDateString(sDate).equalsIgnoreCase(DateUtils.replaceDateString(eDate));
    }
    ...
    public static String getStartThisWeek(String dateStr) {
        ...
        String result = defaultDateFormater.format(date);
        return result;
    }
    ...
    public static String getYearAgo(String dateStr, Integer years) {
        ...
        return MessageFormat.format("{0}{1}{2}", year.toString(),
    ...
    public static Integer computeDay(String sDate, String eDate) {
        ...
        if (sTime.equals(eTime))
            return 1;
        return Math
            .abs(new Long((eTime.getTimeInMillis() - sTime.getTimeInMillis()) / (1000 * 60 * 60 * 24)).intValue());
    }
    ...
    public static List<Integer> getDayStrByBean(String sDate, String eDate) {
        ...
        do {
            date = DateUtils.getDayBefore(date, 1);
    ...
    public static void main(String[] args) {
        ...
        /*
         * String today = "20100310";
         * System.out.println(convertToMySqlDate(today));
         ...
         * System.out.println(DateUtil.getStartThisYear(getYearAgo(today, -1)));
         * System.out.println(DateUtil.getEndThisYear(getYearAgo(today, -1)));
         * System.out.println(formatNumDate("20100112")); String sDate =
         * "20101122"; String eDate = "20101218";
         * System.out.println(getDayDuration(sDate, eDate));
         * System.out.println(getDayList(sDate, eDate)); int
         * currentMonth=201202; Integer
         * firstMonth=getMonthBefore(currentMonth,1); Integer
         * secondMonth=getMonthBefore(currentMonth,2); Integer
